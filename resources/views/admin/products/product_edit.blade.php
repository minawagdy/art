...
{{-- end test --}}
                ...
                <div class="mt-3">
                        ...
                        <div class="mt-2">
                            <select data-placeholder="Select Category" class="tom-select w-full tomselected" id="category-dropdown" tabindex="-1" hidden="hidden" name="category_id">
                                <option selected="true" value="{{$product->category->id ?? ''}}">{{$product->category->title_en ?? ''}}</option>
                        ...
                        <div class="mt-3">
                            <label>Category</label>
                            <div class="mt-2">
                                <select data-placeholder="Select subcategory" class="tom-select w-full tomselected" id="subcategory-dropdown" tabindex="-1" hidden="hidden" name="subcategory_id">
                                    <option selected="true" value="{{$product->subcategory->id ?? ''}}">{{$product->subcategory->title_en ?? ''}}</option>
