        ...
        <div id="vertical-form" class="p-5">
            <div class="preview">
                ...
                <div class="mt-3">
                        ...
                        <div class="mt-2">
                            <select data-placeholder="Select Category" class="tom-select w-full tomselected" id="tomselect-1  category-dropdown" tabindex="-1" hidden="hidden" name="category_id">
                        ...
                        <div class="mt-3">
                            <label>Category</label>
                            <div class="mt-2">
                                <select data-placeholder="Select Category" class="tom-select w-full tomselected" id="tomselect-1  subcategory-dropdown" tabindex="-1" hidden="hidden" name="category_id">
                                    <option selected="true" value="">Select Provider</option>
