...
<div class="intro-y col-span-12 lg:col-span-6 mt-5">
    ...
    <div class="intro-y box">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            ...
            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{route('page.update',['id' => $page->id])}}" enctype="multipart/form-data">
                @method('PUT')
...
{{--@dd($errors->has('title'));--}}
        <div id="vertical-form" class="p-5">
            <div class="preview">
                ...
                <div class="mt-3">
                    <label for="vertical-form-2" class="form-label">Title En *</label>
                    <input id="vertical-form-2" type="text" class="form-control"  name="title_en" value="{{$page->title_en}}" required>
                </div>
                @error('title_en')
                ...
                <div class="mt-3">
                    ...
                    <input id="vertical-form-2" type="text" class="form-control"  name="title_ar" value="{{$page->title_ar}}" required>
                </div>
                @error('title_ar')
                <div class="error">{{ $message }}</div>
                @enderror
                ...
                <div class="mt-3"> 
                    ...
                    <textarea  id="editor"  class="form-control" name="description_en">{{$page->description_en}}</textarea>
                </div>
                ...
                <div class="mt-3"> 
                    ...
                    <textarea id="editor1" class="form-control" name="description_ar" >{{$page->description_ar}}</textarea>
                </div>
...
<script>
    // Replace '27.1.0' with the CKEditor version you want to use
    ClassicEditor
