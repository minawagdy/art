...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{route('page.store')}}" class="btn btn-primary shadow-md mr-2">{{__('Add New Page')}}</a>
        <div class="dropdown">
            ...
            <tr class="intro-x">
                ...
                <td class="table-report__action w-56">
                    <div class="flex justify-center items-center">
                        <a class="flex items-center mr-3" href="{{ route('page.edit', ['id' => $page->id]) }}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                        <!-- <a class="flex items-center text-danger" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a> -->
                        <a class="flex items-center text-danger" href="{{ route('page.destroy', ['id' => $page->id]) }}" > <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                ...
                <div class="px-5 pb-8 text-center">
                    ...
                    <a href="" type="button" class="btn btn-danger w-24">Delete</a>
                </div>
            </div>
        </div>
    </div>
