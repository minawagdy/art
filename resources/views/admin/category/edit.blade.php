        ...
        <div id="vertical-form" class="p-5">
            <div class="preview">
                <div>
                    ...
                    <input id="vertical-form-1" type="text" class="form-control" name="title_en" value="{{($category->title_en)}}">
                </div>
                @error('title_en')
                ...
                <div class="mt-3">
                    ...
                    <div class="flex flex-col sm:flex-row mt-2">
                        <div class="form-check mr-2">
                            <input id="checkbox-switch-{{$country->id}}" class="form-check-input" type="checkbox" value="{{$country->id}}" @if(in_array($country->id,json_decode($category->country))){{'checked'}}@endif name="country[]">
